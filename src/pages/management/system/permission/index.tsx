...
const mockPermissions: Permission_Old[] = [
	...
	},
	{
		...
		name: "用户管理",
		label: "sys.nav.usermgmt.system.user",
	...
	},
	{
		...
		parentId: "perm-system",
		name: "菜单管理",
		label: "sys.nav.usermgmt.system.permission",
	...
	},
	{
		...
		parentId: "perm-system",
		name: "角色管理",
		label: "sys.nav.usermgmt.system.role",
	...
	},
	{
		...
		parentId: "perm-system",
		name: "任务审批",
		label: "sys.nav.usermgmt.system.approval",
		route: "/management/system/approval",
		component: "/pages/management/system/approval",
		icon: "solar:verify-outline",
		hide: false,
		status: BasicStatus.ENABLE,
		type: PermissionType.MENU,
		order: 4,
